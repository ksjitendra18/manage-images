...
const handleSubmit = async (event: Event) => {
    ...
    try {
        const res = await fetch('http://localhost:9999/.netlify/functions/login', {
            method: 'POST',
        ...
        <div class="w-full flex items-center justify-center flex-col">
            ...
            <form class="form-control gap-3 md:w-[400px]" @submit="handleSubmit">
                <div>
                    ...
                    <input v-model="emailInput" name="email" id="email" type="text" placeholder="name@email.com"
                ...
                <div>
                    ...
                    <input v-model="passwordInput" name="password" id="password" type="password" placeholder="6+ characters"
                        class="input input-bordered w-full max-w-md" required />
                </div>
